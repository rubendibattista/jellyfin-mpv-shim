...
def make_exe(dist):
    ...
    policy.resources_location_fallback = "filesystem-relative:Resources"
    ...
    python_config.run_command = "from jellyfin_mpv_shim.mpv_shim import main_desktop; main_desktop()"
    # python_config.run_module = "<module>"

    # Run a Python file when the interpreter starts.
    # python_config.run_filename = "run.py"
    ...
    exe.add_python_resources(exe.pip_install([".[desktop]"]))
...
PYOXIDIZER_VERSION = "0.11.0-pre-7d00d53945167640a4f0db801aea97e492baad39"
PYOXIDIZER_COMMIT = "7d00d53945167640a4f0db801aea97e492baad39"
